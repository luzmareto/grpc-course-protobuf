...
// detail error validation untuk wrapper response
type ValidationError struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Field         string                 `protobuf:"bytes,1,opt,name=field,proto3" json:"field,omitempty"`     // nama field yang error
	Message       string                 `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"` // pesan error
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
